...
function App() {
  return (
    <div>
      ...
      <div>
        <h1 className="display-1 my-5 text-center">React Bootstrap Template</h1>
      </div>

      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-cols-xxl-6 gap-5 justify-content-center">
